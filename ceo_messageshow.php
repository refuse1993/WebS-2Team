						...
						<!-- Content -->
							<div id="content">
								<article class="box post">
                      													...
                      													bgcolor=#89410b class="table-striped">
                      															<tr height=20 bgcolor=#999999>
                      																	...
                      																	<td width=50 align=center>
                      																			<font color=white>이 름</font>
                      																	</td>
                      																	<td width=60 align=center>
                      																			<font color=white>번 호</font>
                      																	</td>
                      																	<td width=500 align=center>
                      																			<font color=white>내 용</font>
                      																	</td>
                      															</tr>
                      													<?php
                      													...
                      													$queryData=mysql_query('select * from message order by id desc limit '.$no.', '.$page_size.'');
                      													if(!$queryData){
                      															echo('query error :'.mysql_error());
                      													}

                      													$result_count=mysql_query('select count(*) FROM message');
                      															...
                      															?><tr>
                      																	...
                      																	<td height=20 bgcolor=white>
                      																		...
                      																		<td align=center height=20 bgcolor=white>
                      																			<font color=black><?=$row[phone]?></td>
                      																		<td align=center height=20 bgcolor=white>
                      																			<font color=black><?=$row[message]?></td>
                      									<?php
                      													}
                      												?>
                      											</tr>
